...
public class JMenuBarChef extends JMenuBar{
	 ...
	 */
		...
		mntmNuevo = new JMenuItem("crear receta");
		mnArchivo.add(mntmNuevo);
		
		mntmEditar = new JMenuItem("Editar receta");
	...
	public JMenuItem getNuevoJItem(){
		return mntmNuevo;
	}
	public JMenuItem getEditarJItem(){
		return mntmEditar;
	}
	public JMenuItem getFavoritosJItem(){
		return mntmFavoritos;
	}
